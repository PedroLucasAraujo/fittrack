...
| `BookingRescheduled` | Booking | Scheduling | oldScheduledAtUtc, newScheduledAtUtc, rescheduledBy |
...
| `SelfLogCorrectionProjected` | SelfLogEntry | Execution / PersonalMode | selfLogEntryId, originalEntryId, clientId, professionalProfileId, logicalDay, correctionId |
