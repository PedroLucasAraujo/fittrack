...
/**
 * Freezes a FinancialLedger, blocking all payout operations until unfrozen.
 * Typically triggered by administrative action or Risk context escalation (ADR-0022).
 * Returns Left(InvalidLedgerStatusTransitionError) if already FROZEN.
 */
export class FreezeFinancialLedger {
  constructor(
