...
/**
 * Unfreezes a FROZEN FinancialLedger, restoring payout eligibility.
 * Returns Left(InvalidLedgerStatusTransitionError) if not currently FROZEN.
 */
export class UnfreezeFinancialLedger {
  constructor(
